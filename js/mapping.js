...
export const 월_간지 = ["인", "묘", "진", "사", "오", "미", "신", "유", "술", "해", "자", "축"];
...
export function 십이운성(baseDayStem, branch) {
  const mapping = {
...
export function 십이신살(yearBranch, branch) {
  const mapping = {
